	...
	<tr>
		...
		<img src="images/logo.png" style="margin-left:10px">
			<div style="float:right">
				<a type="button" class="btn btn-success" href="/app_api/list_line.php">线路管理</a>&nbsp;
...
<section class="sidebar">
	<ul class="sidebar-menu">
	  ...
	  <li>
		<a href="/admin/login.php?logout" onclick="if(!confirm('你确定要注销本次登录吗？')){return false;}">
...
<script src="/app_api/nav_files/sidebar-menu.js"></script>
<script>
