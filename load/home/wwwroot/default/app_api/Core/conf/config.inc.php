...
*/
	...
	//自动在地址中附加了用户名和密码
	$cfg['cfg']['userCenter'] = 'http://123.206.63.112:2233/user/index.php?user='.$_GET['username'].'&pass='.$_GET['password'];
	
	
	//请配置点击流量详情时进入的页面
	$cfg['cfg']['info'] = 'http://123.206.63.112:2233/user/index.php?user='.$_GET['username'].'&pass='.$_GET['password'];
