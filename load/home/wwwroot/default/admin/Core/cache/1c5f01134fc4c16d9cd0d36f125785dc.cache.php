...
$get_url = 'index2.php?cid='.$vo['grop'].'&a=view&id='.$vo['id'] ;$page_url = '/article/'.$_GET['cid'].'.html?m='.$_GET['m'].'&a='.$_GET['a'].'&id='.$_GET['id'].'&';$nums = $db_a678e684b32803692aed5f288d040409->getnums();$pageHtml = Page::html($nums, '30', $page_url, $pageType, 10, $s = 7);?>
