...
<script src="/admin/css/jquery.min.js"></script>
<script src="/admin/css/bootstrap.min.js"></script>
<style>
body{
...
?>
	<!-- x -->
	文件夹权限状态:<?php echo $rand ? "<span class=\"label label-success\">[正常]</span>" : "<span class=\"label label-danger\">请给予admin整个文件夹已经子目录0777权限</span>"?><br>
	<hr>
...
curl "http://<span style="color:red;">192.168.1.1:8888</span>/admin/top_api.php?name=$common_name&s=$bytes_sent&r=$bytes_received&version=2"

</pre>
<div class="alert alert-danger">如果您执行完上述步骤！安装功能就已经完成了！本页面只可访问一次！再度访问请删除install.lock</div>
<a type="button" class="btn btn-success" href="/admin/admin.php">访问后台(默认账户密码 admin admin)</a>
	</div>
