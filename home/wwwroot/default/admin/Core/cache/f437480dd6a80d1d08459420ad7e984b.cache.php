...
<div class="index-content">
	...
	<a href="<?php echo INDEX_DOMAIN;?>/index2.php?m=Rolling"><li class="icon i-2"></li>滚动</a>
	<a href="<?php echo INDEX_DOMAIN;?>/index2.php?m=Rolling&a=original"><li class="icon i-3"></li>原创</a>
...
?>
			...
			<div class="new_box_r new_box_in">
				<ul class="new_box_title">
					<li class="on"><a href="<?php echo INDEX_DOMAIN;?>/index2.php?m=Rolling" target="_blank">滚动</a></li>
					<!--<li><a href="<?php echo INDEX_DOMAIN;?>/index2.php?m=Rolling&a=original" target="_blank">原创</a></li>-->
				</ul>
				<ul class="new_box_list">
					<?php
unset($row);
...
?>
		...
		<div class="content_left">
			...
			<div class="jktt" style="margin-top:5px">
               <div class="right-tit"><a href="<?php echo INDEX_DOMAIN;?>/index2.php?m=Rolling&a=original">IT社区原创</a></div>
               <div class="list">
                  <ul>
				<?php
unset($row);
...
foreach($row as $vo){
?>
                      <li><a href="/index2.php?m=Blog&c=Index&a=view&id=<?php echo $vo['id'];?>" title="<?php echo $vo['title'];?>" target="_blank">·&nbsp;<?php echo $vo['title'];?></a></li>
				<?php }; ?>
                  </ul>
				  <div class="clear"></div>
               </div><!--list end-->
