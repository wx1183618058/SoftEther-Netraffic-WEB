...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"24"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
		...
		<div class="a-con-left">
			...
			<?php $codeurl = base64_encode('index2.php?cid='.$_GET['cid'].'&a=view&id='.$_GET['id'].'&page='.$_GET['p']);?>
			<div class="replay">
				<div class="re-tit">
					<i>我有话说...</i>
				</div>
				<div class="textarea">
				<form action="/index2.php?cid=<?php echo $_GET['cid'];?>&a=re&id=<?php echo $_GET['id'];?>&backurl=<?php echo $codeurl;?>" method="POST">
				...
				<input value="查看评论" type="button" class="re-button re-post" onclick="javascript:window.location.href='index2.php?cid=<?php echo $_GET['cid'];?>&a=relist&id=<?php echo $_GET['id'];?>';">
				<?php }else{ ?>
					...
					<?php $uinfo = U::getinfo($v['userid']);?>
						<table class="re-line" border="0" cellspacing="0" cellpadding="0">
							...
							<div class="re-con">
								...
								<?php }else{ ?>
								<div class="pre"><?php echo mb_substr($v['content'],0,150,'utf8');?>...<a href="/index2.php?cid=<?php echo $_GET['cid'];?>&a=relist&id=<?php echo $_GET['id'];?>">[more]</a></div>
								<?php }; ?>
							</div>
						</td>
					</tr>
...
$(function(){
	...
	$('.goodBtn').click(
		function(){
			$.post(
				'/index2.php?cid=<?php echo $_GET['cid'];?>&a=zan&id=<?php echo $_GET['id'];?>',
				{
					'zan':'zan'
				},
				function(data){
