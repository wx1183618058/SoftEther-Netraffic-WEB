...
<div class="head_top">
	<div style="margin:auto;width:1000px;">
		...
		<div class="head_right"><?php if($_DDCMS['userinfo'] == null){;?>
			<a href="<?php echo USER_DOMAIN;?>/index2.php?c=Index&a=login">登录</a>|<a href="<?php echo USER_DOMAIN;?>/index2.php?c=Index&a=reg">注册</a>
			<?php }else{ ?>
			<a href="<?php echo USER_DOMAIN;?>/index2.php?"><?php echo $_DDCMS['userinfo']['nickname'];?></a><a href="<?php echo USER_DOMAIN;?>/index2.php?">[个人中心]</a>
			<?php }; ?>
		</div>
	</div>
</div>
...
<div class="head_box">
	...
	<div class="head_row">
		...
		<div class="head_line">
			<b><a href="/index2.php?m=Blog">博客大厅</a></b>
				<b><a href="/index2.php?m=tool">工具</a></b>
		</div>
		
		<div class="head_line">
			<b><a href="/article/44.html">操作系统</a></b>
		
			<b><a href="/index2.php?m=Game">游戏</a></b>
		</div>
	</div>
	...
	<div class="head_row last">
		...
		<div class="head_line">
		<b><a href="/index2.php?m=Weibo">微博互动</a></b>
		</div>
	</div>
</div>
<script>
